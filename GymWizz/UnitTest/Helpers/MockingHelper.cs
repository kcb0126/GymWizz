...
namespace GymWizz.UnitTest.Helpers
{
    public static class MockingHelper
    {
        public static Mock<DbSet<TEntity>> AsMockDbSet<TEntity>(this IQueryable<TEntity> data) where TEntity : class
        {
        ...
        public static Mock<DbSet<TEntity>> AsMockDbSet<TEntity>(this IEnumerable<TEntity> data) where TEntity : class
        {
